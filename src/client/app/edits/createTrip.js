(function () {
    ...
    CreateTrip.$inject = ['$scope', '$http', '$window', 'common', 'dataFactory', '$location', 'uiGmapGoogleMapApi', 'uiGmapIsReady', '$timeout'];

    function CreateTrip($scope, $http, $window, common, dataFactory, $location, uiGmapGoogleMapApi, uiGmapIsReady, $timeout) {
        ...
        uiGmapIsReady.promise()
            .then(function (maps) {
                ...
                $scope.submitCreateTrip = function () {
                    ...
                    dataFactory.submitNewTrip(geoJson).success(function (data) {
